...
const MyBorrowedBooks = () => {
  ...
  const { useBorrowedBooks } = useSelector(state => state.borrow);
  ...
  const returnedBooks = useBorrowedBooks?.filter(books => {
    return book.returned === true;
  });
  const nonReturnedBooks = useBorrowedBooks?.filter(books => {
