    ...
    <>
      <main className="relative flex-1 p-6 pt-28">
        ...
        <div className="flex flex-col-reverse xl:flex-row">
          {/* LEFT SIDE */}
          <div className="flex flex-[4] flex-col gap-7 1g:gap-7 lg:py-5 justify-between xl:min-h-[85.5vh]">
            <div className="flex flex-col gap-7 flex-[4]">
              <div className="flex flex-col lg:flow-root gap-7 overflow-y-hidden">
                ...
                rounded-lg transition hover :shadow-inner duration-300">
                  <span className="w-[2px] bg-black h-20 1g:h-full"></span>
              ...
              rounded-lg transition hover : shadow-inner duration-300">
                  ...
                  <span className="bg-gray-300 h-20 lg:h-full min-w-20 flex justify-center items-center
                  rounded-lg">
                    <img src={returnIcon} alt="book-icon"
                      className="w-8 h-8" /></span>I
              ...
              <div className="flex flex-col lg:flex-row gap-7">
                ...
                <img src={logo_with_title} alt="logo_with_title" className="hidden lg-block w-auto justify-end" />
              </div>
            </div>
            ...
            font-semibold relative flex-[3] flex justify-center items-center rounded-2xl">
              <h4 className="overflow-y-hidden"> "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Magnam, veniam totam cupiditate tenetur consequuntur cumque recusandae unde, possimus dolorum pariatur corporis nihil deleniti provident."</h4>
              <p className="text-gray-600 text-sm sm:text-lg absolute right-[35px]
              sm:right-[78px] bottom-[10px]">~OUTR E Library Team</p>
            </div>
          </div>
          {/* RIGHT SIDE */}
