...
// Added missing imports based on your function calls
    ...
    <>
      <aside
        className={`${isSideBarOpen ? "left-0" : "-left-full"
          } z-10 transition-all duration-700 md:relative md:left-0 flex w-64 bg-slate-600 text-white flex-col h-full`}
        style={{
          position: "fixed",
        }}
      >
        <div className="px-6 py-6 my-8">
        ...
        <nav className=" flex-1 px-6 space-y-2">
          ...
          {isAuthenticated && user?.role === "Admin" && (
            <>
              ...
              >
                {/* Fixed: usersIcon was lowercase in import */}
        ...
        <div className="px-6 py-6">
          <button
           ...
           rounded-md hover:cursor-pointer flex items-center
            justify-center space-x-5 mx-auto w-fit"
